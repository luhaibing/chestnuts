...
enum class Type(
    ...
    HEADER(Header::class, intArrayOf(FLAG_PUT, FLAG_DELETE, FLAG_POST, FLAG_GET)),
    QUERY(Query::class, intArrayOf(FLAG_PUT, FLAG_DELETE, FLAG_POST, FLAG_GET)),
    FIELD(Field::class, intArrayOf(FLAG_POST or FLAG_FORM)),
    PART(Part::class, intArrayOf(FLAG_POST or FLAG_MULTIPART))
}

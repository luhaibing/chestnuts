 ...
 */
internal typealias Execute<T> = suspend () -> T
internal typealias Source<T> = suspend (Path, CacheKeys, Deserializer<T>) -> T?
internal typealias Sink<T> = suspend (T?, Path, CacheKeys, Serializer<T>) -> Unit
